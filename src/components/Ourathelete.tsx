...
// Data for the athletes, using placeholder images
const athletes = [
  { 
...
const OurAthlete: React.FC = () => {
  return (
    // Top margin remains to prevent navbar overlap
    <section className="mt-32 py-20 px-4 sm:px-6 lg:px-8 font-['Inter'] bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Increased gap-x to decrease card width. Increased mt and gap-y for new image size. */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-20 gap-y-32 mt-28">
          {athletes.map((athlete, index) => (
            ...
            >
              {/* Athlete image - Increased size and adjusted position */}
